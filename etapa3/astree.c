...
void astPrint(AST * node,int level){
	...
	if(node){
		...
		switch(node->type){
			...
			case AST_KWBYTE:
				fprintf(stderr, "AST_KWBYTE,");
				break;
			case AST_KWSHORT:
				fprintf(stderr, "AST_KWSHORT,");
				break;
			case AST_KWLONG:
				fprintf(stderr, "AST_KWLONG,");
				break;			
			case AST_KWFLOAT:
				fprintf(stderr, "AST_KWFLOAT,");
				break;
			case AST_KWDOUBLE:
				fprintf(stderr, "AST_KWDOUBLE,");
				break;
			case AST_KWIF:
				fprintf(stderr, "AST_KWIF,");
				break;
			case AST_KWTHEN:
				fprintf(stderr, "AST_KWTHEN,");
				break;
			case AST_KWELSE:
				fprintf(stderr, "AST_KWELSE,");
				break;	

			case AST_KWWHILE:
				fprintf(stderr, "AST_KWWHILE,");
				break;
			case AST_KWFOR:
				fprintf(stderr, "AST_KWFOR,");
				break;
			case AST_KWREAD:
				fprintf(stderr, "AST_KWREAD,");
				break;			
			case AST_KWRETURN:
				fprintf(stderr, "AST_KWRETURN,");
				break;
			case AST_KWPRINT:
				fprintf(stderr, "AST_KWPRINT,");
				break;
			case AST_TKID:
				fprintf(stderr, "AST_TKID,");
				break;
			case AST_EXP:
			...
			case AST_FUNDEC:
				...
				break;
			case AST_VTL:
				fprintf(stderr, "AST_VTL,");
				break;	

			case AST_LIT:
				fprintf(stderr, "AST_LIT,");
				break;
			case AST_LITLIST:
				fprintf(stderr, "AST_LITLIST,");
				break;
			case AST_VARTYPE:
				fprintf(stderr, "AST_VARTYPE,");
				break;			
			case AST_ARGSDEF:
				fprintf(stderr, "AST_ARGSDEF,");
				break;
			case AST_ASSIGN:
				fprintf(stderr, "AST_ASSIGN,");
				break;
			case AST_PRINTARGS:
				fprintf(stderr, "AST_PRINTARGS,");
				break;
			case AST_ARGS:
				fprintf(stderr, "AST_ARGS,");
				break;
			case AST_VTLIST:
				fprintf(stderr, "AST_VTLIST,");
				break;	
